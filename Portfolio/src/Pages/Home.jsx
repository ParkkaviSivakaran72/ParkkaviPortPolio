...
export default function Home() {
  ...
  const quickStats = [
    ...
    { number: "2+", label: "Awards Won", icon: "🏆" },
  ];
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
    >
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className={`relative transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {quickStats.map((stat, index) => (
                  ...
                  >
                    ...
                    <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stat.number}</div>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/60 backdrop-blur p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-gray-50/60 dark:bg-gray-800/40 rounded-xl hover:bg-gray-100/60 dark:hover:bg-gray-800/60 transition-colors">
                  ...
                  <a className="text-sm text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors" href={`mailto:${email}`}>
                    {email}
                  </a>
                </div>
                ...
                <div className="flex items-center gap-3 p-3 bg-gray-50/60 dark:bg-gray-800/40 rounded-xl hover:bg-gray-100/60 dark:hover:bg-gray-800/60 transition-colors">
                  ...
                  <a className="text-sm text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors" href={`tel:${phone.replace(/\s+/g, "")}`}>
                    {phone}
                  </a>
                </div>
            ...
            <div className="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/60 backdrop-blur p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Connect With Me</h2>
              </div>
              ...
              <div className="space-y-3">
                {socials.map((social) => (
                  ...
                  >
                    ...
                    <svg className="h-4 w-4 ml-auto group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </a>
                ))}
            ...
            <div className="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/60 backdrop-blur p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">About Me</h2>
              </div>
              
              <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400 mb-4">
                Passionate Computer Science & Engineering student at University of Moratuwa, 
                specializing in full-stack development with React, Node.js, Express, and Spring Boot. 
                Experienced in building scalable applications with modern databases and REST APIs.
              </p>
          ...
          <div className="text-center mt-12">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Explore my journey</p>
