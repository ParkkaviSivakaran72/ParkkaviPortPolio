...
export default function Experience() {
  const volunteering = [
    ...
    { role: "Tech Team Volunteer", org: "University Tech Fest", period: "Mar 2024" },
  ];
  ...
  const certifications = [
    ...
    { title: "JavaScript Algorithms", org: "freeCodeCamp", date: "Nov 2024" },
  ];
  ...
  const awards = [
    ...
    { title: "Best UI/UX Design Award", org: "Code Sprint 2024", date: "Sep 2024" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
        <StatCard number={volunteering.length} label="Volunteer Roles" icon="🤝" />
        <StatCard number={certifications.length} label="Certifications" icon="📜" />
        <StatCard number={awards.length} label="Awards" icon="🏆" />
        <StatCard number="3+" label="Organizations" icon="🏢" />
      </div>
